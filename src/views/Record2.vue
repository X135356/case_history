            ...
            (function() {
                ...
                var N = (function() {
                    function C() {
                        ...
                        for (var a = 0; a < c.length; a++) {
                            ...
                            if(time_data){
                                time_data = 0;
                                let vcc_y = c[a].solarYear;
                                let vcc_m = c[a].solarMonth;
                                let vcc_t = c[a].solarDate;
                                vcc_m = vcc_m<10?'0'+vcc_m:vcc_m;
                                vcc_t = vcc_t<10?'0'+vcc_t:vcc_t;
                                let vcc_time = 0;
                                let vcc_time_ = 0;
                                vcc_time = new Date(vcc_y+'-'+vcc_m+'-'+vcc_t);
                                vcc_time_ = vcc_time.getTime()/1000;
                                console.log(vcc_time_);
                            }
                            if(aasdfadsfa){
                                X.className = "cell yes1";
                            }else{
                                X.className = "cell";
                            }
                ...
                var F = (function() {
                    ...
                    function G(b) {
                        ...
                        if(aasdfadsfa){
                            c = '<div style="margin:0 0 5px;font-size:16px;font-weight:600;color:#333;background:#eee;">123456</div>';
                        }
                        c += "#{solarYear}&nbsp;年&nbsp;#{solarMonth}&nbsp;月&nbsp;#{solarDate}&nbsp;日&nbsp;#{solarWeekDayInChinese}";
...
<style>
    ...
    #cal{width:100%;border:1px solid #c3d9ff;font-size:12px;}
    ...
    #cal ul#wk li{float:left;width:14.2%;text-align:center;line-height:25px;list-style:none}
